...
class Node(Persistent):
    """
    A Persistent class that has the root or another node as its parent
    It has an OOBTree of the children of this object
    It's ID is generated by uuid
    It implements the __getitem__ method
    """
...
class Leaf(Persistent):
    """
    A Persistent class that has a Node as its parent
    Its the leaf object and has no children
    It's ID is generated by uuid
    It does not implement the __getitem__ method
    It has Quantity and Rate attributes
    """
        ...
        # try:
            ...
            while line != "EOF":
                ...
                if line == "=":
                    ...
                    project = Node(name, desc, app_root.ID)
                    ...
                    while line != "=" and line != "EOF":
                        ...
                        if line == "+":
                            ...
                            budgetgroup = Node(gname, gdesc, project.ID)
                            line = datafile.next().rstrip()
